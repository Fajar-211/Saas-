    ...
    <!-- Hero Section -->
     <div class="flex flex-col items-center justify-center text-center bg-[url('/assets/hero-section-dot-image.png')] bg-cover bg-no-repeat bg-sky-100">
        ...
        <div class="flex items-center gap-4 mt-6">
            <button class="bg-indigo-600 hover:bg-indigo-700 transition px-8 py-3 rounded-md text-white">
        ...
        <Transition name="bounce">
            <img v-if="bounce" class="w-full max-w-xl mt-16 drop-shadow-2xl drop-shadow-blue-500/15 mx-auto" src="/assets/hero-section-card-image.svg" alt="Hero Section Card Image" width={1000} height={500} />
        </Transition>
    </div>
